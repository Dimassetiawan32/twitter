    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel shadow-sm">
            <div class="container">
                ...
                <img src="{{asset('images/tweet.png')}}" class="nav-link" height="40" alt="">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item">
                    <!-- <img src="http://localhost/twitter/public/images/tweet.png" class="nav-link" height="40" style="display: block; margin: auto;" alt=""> -->
                    </li>
                        <li class="nav-item">    
                        ...
                        <li class="nav-item">    
                            <span class="nav-link"><svg height="16px" id="Layer_1" style="enable-background:new 0 0 16 16;" version="1.1" viewBox="0 0 16 16" width="16px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path d="M2,6C0.896,6,0,6.896,0,8s0.896,2,2,2s2-0.896,2-2S3.104,6,2,6z M8,6C6.896,6,6,6.896,6,8s0.896,2,2,2s2-0.896,2-2  S9.104,6,8,6z M14,6c-1.104,0-2,0.896-2,2s0.896,2,2,2s2-0.896,2-2S15.104,6,14,6z"/></svg></span>
                        </li>
